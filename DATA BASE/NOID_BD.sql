...
-- Crear tabla SECUENCIA_PRODUCTO
CREATE TABLE SECUENCIA_PRODUCTO (
    ID_CATEGORIA VARCHAR(10) PRIMARY KEY,
    ULTIMO_NUMERO INT NOT NULL DEFAULT 0
);

-- Insertar secuencias de productos para cada categoría
...
CREATE TRIGGER actualizar_estado_producto_update
...
CREATE TABLE RECIBO (
    ...
    DESCRIPCION_RECIBO VARCHAR(255),
...
-- Crear el trigger para generar el ID_PRODUCTO
DELIMITER $$
...
('PC', 'Computadora Gamer', 'GTX-FX900', 900.00, '2025-04-09', 10, 'DISPONIBLE', 'Equipo de alto rendimiento para gaming.', 'pc1.jpg', 'SN-PC-001'),
('LAP', 'Laptop Lenovo ThinkPad', 'LTP-X100', 800.99, '2025-04-08', 5, 'CASI AGOTADO', 'Laptop ideal para trabajo y estudio.', 'lap1.jpg', 'SN-LAP-001'),
...
INSERT INTO RECIBO (ID_USUARIO, ID_COMPRA, TOTAL_PRECIO, FECHA_RECIBO, NUMERO_VISA) VALUES
(5, 1, 900.00, '2025-04-09', '4111111111111111'),
(6, 2, 800.99, '2025-04-09', '4222222222222222'),
